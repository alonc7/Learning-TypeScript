...
import { tileIsEmptyOrOccupiedByOpponent, tileIsOccupied } from "./GeneralLogic";


export const isQueenValidMove = (initialPosition: Position, desiredPosition: Position, team: TeamType, boardState: Piece[]): boolean => {
    for (let i = 1; i < 8; i++) {
        //Diagonal
