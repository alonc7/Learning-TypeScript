...
import { isBishopValidMove, isKingValidMove, isKnightValidMove, isPawnValidMove, isQueenValidMove, isRookValidMove } from "../../referee";
import "./Referee.css"
export default function Referee() {
    ...
    function isValidMove(initialPosition: Position, desiredPosition: Position, type: PieceType, team: TeamType) {
        ...
        switch (type) {
            case PieceType.PAWN:
                validMove = isPawnValidMove(initialPosition, desiredPosition, team, board.pieces);
                break;
            case PieceType.KNIGHT:
                validMove = isKnightValidMove(initialPosition, desiredPosition, team, board.pieces);
                break;
            case PieceType.BISHOP:
                validMove = isBishopValidMove(initialPosition, desiredPosition, team, board.pieces);
                break;
            case PieceType.ROOK:
                validMove = isRookValidMove(initialPosition, desiredPosition, team, board.pieces);
                break;
            case PieceType.QUEEN:
                validMove = isQueenValidMove(initialPosition, desiredPosition, team, board.pieces);
                break;
            case PieceType.KING:
                validMove = isKingValidMove(initialPosition, desiredPosition, team, board.pieces);
        }
