...
export class Board {
    ...
    get currentTeam(): TeamType {
        return this.totalTurns % 2 === 0 ? TeamType.OPPONENT : TeamType.TEAMMATE;
    }
    ...
    calculateAllMoves() {
        ...
        this.winningTeam = (this.currentTeam === TeamType.TEAMMATE) ? TeamType.OPPONENT : TeamType.TEAMMATE;
    }
    ...
    playMove(enPassantMove: boolean,
        ...
        const pawnDirection = playedPiece.team === TeamType.TEAMMATE ? 1 : -1;
